  ...
  <div class="container">
    ...
    <div class="article-section">
      <div class="profile-img-wrapper">
        <img class="profile-img" src="/upload/Produkfoto1.png" alt="Profile Image" />
      </div>
      <div class="profile-info">
      <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: -10px;">Sabun Cuci Mobil Premium-</h2>
      <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: -10px;">ShineGuard</h2>
    <p class="article-content">
    Sabun cuci mobil ini diformulasikan khusus untuk menghilangkan kotoran, minyak, dan debu tanpa merusak lapisan pelindung cat mobil. Dengan teknologi pH seimbang, ShineGuard aman untuk semua jenis cat dan lapisan pelindung mobil. Kandungan wax yang ada di dalamnya membantu menambah kilauan ekstra, serta memberikan lapisan perlindungan tambahan terhadap sinar UV dan polusi. Sabun ini mudah dibilas, tidak meninggalkan residu, dan ideal untuk menjaga tampilan mobil selalu mengkilap dan terlindungi dari kerusakan jangka panjang. Penggunaan secara rutin akan membuat cat mobil tetap terlindungi dari kerusakan akibat polusi lingkungan. Selain itu, ShineGuard diformulasikan dengan bahan-bahan biodegradable sehingga ramah lingkungan dan aman bagi pengguna.</div>
        </p>
      </div>
    </div>
  <div class="footer">
