  ...
  <div class="container">
    ...
    <div class="article-section">
      <div class="profile-img-wrapper">
        <img class="profile-img" src="/upload/faktivitas2.jpg" alt="Profile Image" />
      </div>
      <div class="profile-info">
      <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: -10px;"> Perawatan Berkala </h2>
      <p class="article-content">
      Kami menawarkan layanan perawatan rutin bagi pelanggan yang ingin menjaga kondisi mobil mereka tetap prima. Aktivitas ini mencakup pencucian mendalam, pembersihan interior yang lebih teliti, dan aplikasi perlindungan seperti waxing atau coating untuk mempertahankan kilauan serta melindungi cat mobil dari cuaca buruk dan kerusakan eksternal. Layanan ini ideal untuk pelanggan yang ingin menjaga mobil mereka dalam kondisi optimal dalam jangka panjang. Setiap perawatan berkala dilakukan dengan produk premium yang tidak hanya membersihkan, tetapi juga memberikan lapisan perlindungan tambahan untuk mobil Anda. Perawatan ini juga meliputi pemulihan tampilan eksterior yang kusam, sehingga mobil Anda selalu tampak baru. Dengan layanan ini, pelanggan dapat merasa tenang karena mobil mereka selalu siap untuk berkendara dalam kondisi terbaik.    </div>
        </p>
      </div>
    </div>
  <div class="footer">
