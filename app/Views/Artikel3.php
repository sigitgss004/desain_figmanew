...
.nav-item:hover::after {
  ...
  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);
    ...
    .article-content {
      ...
      line-height: 25px; /* Ukuran lebih kecil */
  ...
  <div class="container">
    ...
    <div class="article-section">
      <div class="profile-img-wrapper">
        <img class="profile-img" src="/upload/fartikel3.png" alt="Profile Image" />
      </div>
      <div class="profile-info">
      <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: -10px;">Teknologi Terbaru dalam Industri Car Wash</h2>
    <p class="article-content">
    Industri cuci mobil terus berinovasi untuk memberikan hasil yang lebih baik dengan cara yang lebih efisien dan ramah lingkungan. Artikel ini mengeksplorasi teknologi terbaru yang telah mengubah cara layanan car wash beroperasi. Mulai dari robotik yang dapat membersihkan kendaraan dengan presisi tinggi hingga teknologi pencucian tanpa air yang hemat sumber daya, artikel ini memberikan wawasan tentang bagaimana inovasi ini tidak hanya memberikan hasil maksimal tetapi juga mengurangi dampak negatif terhadap lingkungan. Teknologi berbasis uap dan produk pembersih berkelanjutan juga dipaparkan sebagai solusi modern yang efektif dan ramah lingkungan untuk menjaga kebersihan mobil Anda.    astikan bahwa mobil Anda mendapatkan perawatan yang optimal sesuai dengan kebutuhan, baik itu untuk menjaga kilau cat, kebersihan interior, atau perlindungan tambahan terhadap cuaca ekstrem.        </p>
      </div>
    </div>
  <div class="footer">
