...
.nav-item:hover::after {
  ...
  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);
    ...
    .article-content {
      ...
      line-height: 32px; /* Ukuran lebih kecil */
  ...
  <div class="container">
    ...
    <div class="article-section">
      <div class="profile-img-wrapper">
        <img class="profile-img" src="/upload/fartikel1.png" alt="Profile Image" />
      </div>
      <div class="profile-info">
      <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: -10px;">Memilih Layanan Car Wash yang Tepat untuk Kendaraan Anda</h2>
    <p class="article-content">
    Memilih layanan cuci mobil yang tepat adalah langkah krusial untuk menjaga tampilan dan keawetan kendaraan Anda. Artikel ini menguraikan berbagai faktor yang harus dipertimbangkan, termasuk jenis layanan yang ditawarkan, seperti cuci eksterior, interior, atau detailing. Artikel ini juga membahas pentingnya memahami produk yang digunakan—apakah ramah lingkungan atau aman untuk cat mobil—serta reputasi penyedia layanan. Dengan panduan praktis ini, Anda dapat mem
    astikan bahwa mobil Anda mendapatkan perawatan yang optimal sesuai dengan kebutuhan, baik itu untuk menjaga kilau cat, kebersihan interior, atau perlindungan tambahan terhadap cuaca ekstrem.        </p>
      </div>
    </div>
  <div class="footer">
