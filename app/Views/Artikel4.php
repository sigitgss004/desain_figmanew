...
.nav-item:hover::after {
  ...
  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);
    ...
    .article-content {
      ...
      line-height: 35px; /* Ukuran lebih kecil */
  ...
  <div class="container">
    ...
    <div class="article-section">
      <div class="profile-img-wrapper">
        <img class="profile-img" src="/upload/fartikel4.png" alt="Profile Image" />
      </div>
      <div class="profile-info">
      <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: -10px;">Manfaat Cuci Mobil Rutin: Lebih dari Sekadar Kebersihan</h2>
    <p class="article-content">
    Banyak pemilik mobil tidak menyadari bahwa mencuci mobil secara rutin bukan hanya soal menjaga penampilan. Artikel ini menjelaskan bahwa perawatan rutin, termasuk pencucian mobil, memainkan peran penting dalam melindungi nilai investasi Anda. Pencucian teratur membantu mencegah penumpukan kotoran dan debu yang dapat menyebabkan kerusakan pada cat, menghindari karat, serta menjaga performa visual kendaraan tetap optimal. Artikel ini juga memberikan informasi kapan waktu terbaik untuk mencuci mobil, berdasarkan kondisi cuaca atau lingkungan, sehingga Anda bisa menjaga mobil tetap awet dan bernilai tinggi.      </div>
    </div>
  <div class="footer">
