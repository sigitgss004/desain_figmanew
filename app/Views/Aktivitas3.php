  ...
  <div class="container">
    ...
    <div class="article-section">
      <div class="profile-img-wrapper">
        <img class="profile-img" src="/upload/faktivitas3.jpg" alt="Profile Image" />
      </div>
      <div class="profile-info">
      <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: -10px;">Pelatihan Tim dan Pengembangan Keterampilan </h2>
      <p class="article-content">
      Layanan berkualitas dimulai dari tim yang terampil dan berpengalaman. Kami secara berkala mengadakan pelatihan untuk seluruh staf kami, baik dalam teknik terbaru pencucian, detailing, maupun penggunaan produk yang aman dan ramah lingkungan. Pelatihan ini memastikan bahwa tim kami selalu up-to-date dengan perkembangan teknologi dan metode terbaik, sehingga setiap kendaraan yang kami tangani mendapatkan perawatan optimal. Pelatihan juga mencakup pengetahuan tentang layanan pelanggan, memastikan tim kami dapat memberikan pengalaman yang menyenangkan dan profesional kepada setiap klien. Dengan tim yang terlatih, kami dapat menjamin standar layanan tinggi dan konsistensi dalam setiap pekerjaan. Pelatihan berkelanjutan juga membuka ruang untuk inovasi, sehingga kami terus meningkatkan kualitas layanan yang kami tawarkan.     </div>
        </p>
      </div>
    </div>
  <div class="footer">
