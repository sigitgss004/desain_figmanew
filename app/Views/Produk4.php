  ...
  <div class="container">
    ...
    <div class="article-section">
      <div class="profile-img-wrapper">
        <img class="profile-img" src="/upload/Produkfoto4.png" alt="Profile Image" />
      </div>
      <div class="profile-info">
      <h2 style="font-size: 40px; font-weight: 700; margin-left: 50px; margin-top: -5px;">Pelindung Ban-</h2>
      <h2 style="font-size: 40px; font-weight: 700; margin-left: 50px; margin-top: -5px;">TireShine Pro</h2>
    <p class="article-content">
    TireShine Pro memberikan hasil kilauan hitam pekat yang membuat ban terlihat seperti baru, sekaligus melindungi dari retakan, kekeringan, dan efek penuaan. Dengan formula tahan air, produk ini menjaga ban tetap mengkilap bahkan dalam kondisi cuaca buruk atau setelah berkendara di jalan basah. TireShine Pro tidak hanya memberikan tampilan estetis pada ban, tetapi juga melindungi dari sinar UV dan faktor lingkungan yang bisa mempercepat kerusakan, sehingga ban tetap tampak segar dan awet lebih lama. Aplikasinya cepat dan tidak lengket, sehingga ban terlihat bersih tanpa menimbulkan residu. Dengan perawatan rutin, ban akan tetap elastis dan tahan lama, memastikan kenyamanan dan keamanan berkendara.</div>
        </p>
      </div>
    </div>
  <div class="footer">
