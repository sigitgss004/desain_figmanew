...
<body>
  ...
  <div class="container">
    <div class="header">
      ...
      <img class="logo" src="<?= base_url('upload/' . $produk->logo); ?>" alt="Logo">
    </div>
    ...
    <div class="overlay">
      ...
      <div class="article-label"><?= lang('Blog.produk'); ?></div>
    </div>
    ...
    <div class="article-section">
      ...
      <div class="profile-info">
        <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: 40px;"><?= ($lang === 'id') ? $produk->title_produk : $produk->title_produk_en; ?></h2>
