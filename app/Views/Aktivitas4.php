...
.nav-item:hover::after {
  ...
  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);
    ...
    .article-content {
      ...
      line-height: 31px; /* Ukuran lebih kecil */
  ...
  <div class="container">
    ...
    <div class="article-section">
      <div class="profile-img-wrapper">
        <img class="profile-img" src="/upload/faktivitas4.jpg" alt="Profile Image" />
      </div>
      ...
      Layanan berkualitas dimulai dari tim yang terampil dan berpengalaman. Kami secara berkala mengadakan pelatihan untuk seluruh staf kami, baik dalam teknik terbaru pencucian, detailing, maupun penggunaan produk yang aman dan ramah lingkungan. Selain teknik pencucian, staf kami juga dilatih dalam hal manajemen waktu dan efisiensi kerja, yang memungkinkan pelayanan lebih cepat tanpa mengorbankan kualitas. Kami selalu memastikan bahwa setiap anggota tim memiliki kemampuan untuk memahami kebutuhan pelanggan dan memberikan layanan sesuai ekspektasi. Dengan komitmen ini, pengembangan keterampilan berkelanjutan adalah kunci untuk memberikan pengalaman terbaik bagi pelanggan.     </div>
        </p>
      </div>
    </div>
  <div class="footer">
