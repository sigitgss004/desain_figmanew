  ...
  <div class="container">
    ...
    <div class="article-section">
      <div class="profile-img-wrapper">
        <img class="profile-img" src="/upload/Produkfoto2.png" alt="Profile Image" />
      </div>
      <div class="profile-info">
      <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: -10px;">Cairan Pembersih Interior-</h2>
      <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: -10px;">FreshShield</h2>
    <p class="article-content">
    FreshShield adalah cairan pembersih interior serbaguna yang efektif membersihkan berbagai permukaan dalam mobil, termasuk dashboard, panel pintu, jok, dan karpet. Dengan formula lembut namun kuat, produk ini mampu mengangkat noda, debu, dan kotoran yang menempel tanpa merusak material. Selain itu, FreshShield mengandung zat antibakteri untuk menjaga kebersihan interior, serta memberikan aroma segar yang tahan lama, menciptakan suasana bersih dan nyaman setiap kali Anda masuk ke dalam mobil. Produk ini juga cepat kering dan tidak meninggalkan bekas lengket, sehingga permukaan interior tetap terawat. Kelebihan lainnya adalah formula anti-statis yang membantu mengurangi penumpukan debu pada permukaan interior, menjaga kebersihan lebih lama.</div>
        </p>
      </div>
    </div>
  <div class="footer">
