...
<?php
  ...
  <div class="container">
    ...
    <div class="overlay">
      ...
      <div class="article-label"><?=lang('Blog.aktivitas1');?></div>
    </div>
    ...
    <div class="article-section">
      <div class="profile-img-wrapper">
        <img class="profile-img" src="/upload/<?= $aktivitas->img_aktivitas ?>" alt="Profile Image" />
      </div>
      <div class="profile-info">
        <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: 40px;"><?= ($lang === 'id') ? $aktivitas->title_aktivitas : $aktivitas->title_aktivitas_en; ?>
        </h2></h2>
        <p class="article-content">
        <?= ($lang === 'id') ? $aktivitas->deskripsi_aktivitas : $aktivitas->deskripsi_aktivitas_en ?>
        </div>
      </p>
    </div>
  </div>
