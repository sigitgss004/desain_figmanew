  ...
  <div class="container">
    ...
    <div class="article-section">
      <div class="profile-img-wrapper">
        <img class="profile-img" src="/upload/fartikel2.png" alt="Profile Image" />
      </div>
      <div class="profile-info">
      <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: -10px;">Detailing Mobil : Apa yang Harus Anda Ketahui?</h2>
    <p class="article-content">
    Detailing mobil adalah lebih dari sekadar pembersihan biasa. Artikel ini membahas apa yang dimaksud dengan detailing mobil, yang meliputi pembersihan mendalam pada bagian eksterior dan interior, seperti membersihkan, memoles, dan melindungi setiap permukaan kendaraan, termasuk jok, dashboard, karpet, dan cat mobil. Anda juga akan mempelajari mengapa detailing berkala penting untuk memperpanjang umur kendaraan Anda, menjaga tampilan profesional, dan memberikan perlindungan ekstra terhadap faktor-faktor eksternal seperti sinar UV dan polusi. Memilih layanan detailing yang tepat akan memastikan kendaraan Anda selalu dalam kondisi prima.    astikan bahwa mobil Anda mendapatkan perawatan yang optimal sesuai dengan kebutuhan, baik itu untuk menjaga kilau cat, kebersihan interior, atau perlindungan tambahan terhadap cuaca ekstrem.        </p>
      </div>
    </div>
  <div class="footer">
